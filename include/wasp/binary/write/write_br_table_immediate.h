...
#ifndef WASP_BINARY_WRITE_WRITE_BR_TABLE_IMMEDIATE_H_
#define WASP_BINARY_WRITE_WRITE_BR_TABLE_IMMEDIATE_H_
...
#endif  // WASP_BINARY_WRITE_WRITE_BR_TABLE_IMMEDIATE_H_
