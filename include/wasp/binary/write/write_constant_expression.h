...
#ifndef WASP_BINARY_WRITE_WRITE_CONSTANT_EXPRESSION_H_
#define WASP_BINARY_WRITE_WRITE_CONSTANT_EXPRESSION_H_
...
#endif  // WASP_BINARY_WRITE_WRITE_CONSTANT_EXPRESSION_H_
