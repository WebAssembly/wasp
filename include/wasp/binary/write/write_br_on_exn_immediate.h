...
#ifndef WASP_BINARY_WRITE_WRITE_BR_ON_EXN_IMMEDIATE_H_
#define WASP_BINARY_WRITE_WRITE_BR_ON_EXN_IMMEDIATE_H_
...
#endif  // WASP_BINARY_WRITE_WRITE_BR_ON_EXN_IMMEDIATE_H_
