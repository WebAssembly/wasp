...
#ifndef WASP_BINARY_WRITE_WRITE_COMDAT_SYMBOL_KIND_H_
#define WASP_BINARY_WRITE_WRITE_COMDAT_SYMBOL_KIND_H_
...
#endif  // WASP_BINARY_WRITE_WRITE_COMDAT_SYMBOL_KIND_H_
