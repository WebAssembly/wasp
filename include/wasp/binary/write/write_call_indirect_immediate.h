...
#ifndef WASP_BINARY_WRITE_WRITE_CALL_INDIRECT_IMMEDIATE_H_
#define WASP_BINARY_WRITE_WRITE_CALL_INDIRECT_IMMEDIATE_H_
...
#endif  // WASP_BINARY_WRITE_WRITE_CALL_INDIRECT_IMMEDIATE_H_
