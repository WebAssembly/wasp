...
TEST(LexTest, PlainInstr) {
  ...
  struct {
    ...
    F::Bits features;
      ...
      {"memory.init"_su8, TT::VarInstr, O::MemoryInit, F::BulkMemory},
      {"memory.size"_su8, TT::BareInstr, O::MemorySize, 0},
      {"nop"_su8, TT::BareInstr, O::Nop, 0},
      {"ref.func"_su8, TT::VarInstr, O::RefFunc, F::ReferenceTypes},
      {"ref.is_null"_su8, TT::BareInstr, O::RefIsNull, F::ReferenceTypes},
      {"ref.null"_su8, TT::BareInstr, O::RefNull, F::ReferenceTypes},
