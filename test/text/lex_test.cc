...
TEST(LexTest, PlainInstr) {
  ...
  struct {
    ...
    F::Bits features;
      ...
      {"call_ref"_su8, TT::BareInstr, O::CallRef, F::FunctionReferences},
      ...
      {"f32x4.ceil"_su8, TT::BareInstr, O::F32X4Ceil, F::Simd},
      ...
      {"f64x2.convert_low_i32x4_s"_su8, TT::BareInstr, O::F64X2ConvertLowI32X4S, F::Simd},
      {"f64x2.convert_low_i32x4_u"_su8, TT::BareInstr, O::F64X2ConvertLowI32X4U, F::Simd},
      {"f32x4.demote_f64x2_zero"_su8, TT::BareInstr, O::F32X4DemoteF64X2Zero, F::Simd},
      ...
      {"f32x4.floor"_su8, TT::BareInstr, O::F32X4Floor, F::Simd},
      ...
      {"f32x4.nearest"_su8, TT::BareInstr, O::F32X4Nearest, F::Simd},
      {"f32x4.neg"_su8, TT::BareInstr, O::F32X4Neg, F::Simd},
      {"f32x4.ne"_su8, TT::BareInstr, O::F32X4Ne, F::Simd},
      {"f32x4.pmax"_su8, TT::BareInstr, O::F32X4Pmax, F::Simd},
      {"f32x4.pmin"_su8, TT::BareInstr, O::F32X4Pmin, F::Simd},
      ...
      {"f32x4.trunc"_su8, TT::BareInstr, O::F32X4Trunc, F::Simd},
      ...
      {"f64x2.ceil"_su8, TT::BareInstr, O::F64X2Ceil, F::Simd},
      ...
      {"f64x2.floor"_su8, TT::BareInstr, O::F64X2Floor, F::Simd},
      ...
      {"f64x2.nearest"_su8, TT::BareInstr, O::F64X2Nearest, F::Simd},
      {"f64x2.neg"_su8, TT::BareInstr, O::F64X2Neg, F::Simd},
      {"f64x2.ne"_su8, TT::BareInstr, O::F64X2Ne, F::Simd},
      {"f64x2.pmax"_su8, TT::BareInstr, O::F64X2Pmax, F::Simd},
      {"f64x2.pmin"_su8, TT::BareInstr, O::F64X2Pmin, F::Simd},
      {"f64x2.promote_low_f32x4"_su8, TT::BareInstr, O::F64X2PromoteLowF32X4, F::Simd},
      ...
      {"f64x2.trunc"_su8, TT::BareInstr, O::F64X2Trunc, F::Simd},
      ...
      {"i16x8.abs"_su8, TT::BareInstr, O::I16X8Abs, F::Simd},
      {"i16x8.add"_su8, TT::BareInstr, O::I16X8Add, F::Simd},
      {"i16x8.add_sat_s"_su8, TT::BareInstr, O::I16X8AddSatS, F::Simd},
      {"i16x8.add_sat_u"_su8, TT::BareInstr, O::I16X8AddSatU, F::Simd},
      {"i16x8.all_true"_su8, TT::BareInstr, O::I16X8AllTrue, F::Simd},
      {"i16x8.avgr_u"_su8, TT::BareInstr, O::I16X8AvgrU, F::Simd},
      {"i16x8.bitmask"_su8, TT::BareInstr, O::I16X8Bitmask, F::Simd},
      {"i16x8.eq"_su8, TT::BareInstr, O::I16X8Eq, F::Simd},
      {"i16x8.extadd_pairwise_i8x16_s"_su8, TT::BareInstr, O::I16X8ExtaddPairwiseI8X16S, F::Simd},
      {"i16x8.extadd_pairwise_i8x16_u"_su8, TT::BareInstr, O::I16X8ExtaddPairwiseI8X16U, F::Simd},
      {"i16x8.extend_high_i8x16_s"_su8, TT::BareInstr, O::I16X8ExtendHighI8X16S, F::Simd},
      {"i16x8.extend_high_i8x16_u"_su8, TT::BareInstr, O::I16X8ExtendHighI8X16U, F::Simd},
      {"i16x8.extend_low_i8x16_s"_su8, TT::BareInstr, O::I16X8ExtendLowI8X16S, F::Simd},
      {"i16x8.extend_low_i8x16_u"_su8, TT::BareInstr, O::I16X8ExtendLowI8X16U, F::Simd},
      {"i16x8.extmul_high_i8x16_s"_su8, TT::BareInstr, O::I16X8ExtmulHighI8X16S, F::Simd},
      {"i16x8.extmul_high_i8x16_u"_su8, TT::BareInstr, O::I16X8ExtmulHighI8X16U, F::Simd},
      {"i16x8.extmul_low_i8x16_s"_su8, TT::BareInstr, O::I16X8ExtmulLowI8X16S, F::Simd},
      {"i16x8.extmul_low_i8x16_u"_su8, TT::BareInstr, O::I16X8ExtmulLowI8X16U, F::Simd},
      ...
      {"i16x8.q15mulr_sat_s"_su8, TT::BareInstr, O::I16X8Q15mulrSatS, F::Simd},
      ...
      {"i16x8.sub_sat_s"_su8, TT::BareInstr, O::I16X8SubSatS, F::Simd},
      {"i16x8.sub_sat_u"_su8, TT::BareInstr, O::I16X8SubSatU, F::Simd},
      ...
      {"i32x4.abs"_su8, TT::BareInstr, O::I32X4Abs, F::Simd},
      {"i32x4.add"_su8, TT::BareInstr, O::I32X4Add, F::Simd},
      {"i32x4.all_true"_su8, TT::BareInstr, O::I32X4AllTrue, F::Simd},
      {"i32x4.bitmask"_su8, TT::BareInstr, O::I32X4Bitmask, F::Simd},
      {"i32x4.dot_i16x8_s"_su8, TT::BareInstr, O::I32X4DotI16X8S, F::Simd},
      {"i32x4.eq"_su8, TT::BareInstr, O::I32X4Eq, F::Simd},
      {"i32x4.extadd_pairwise_i16x8_s"_su8, TT::BareInstr, O::I32X4ExtaddPairwiseI16X8S, F::Simd},
      {"i32x4.extadd_pairwise_i16x8_u"_su8, TT::BareInstr, O::I32X4ExtaddPairwiseI16X8U, F::Simd},
      {"i32x4.extend_high_i16x8_s"_su8, TT::BareInstr, O::I32X4ExtendHighI16X8S, F::Simd},
      {"i32x4.extend_high_i16x8_u"_su8, TT::BareInstr, O::I32X4ExtendHighI16X8U, F::Simd},
      {"i32x4.extend_low_i16x8_s"_su8, TT::BareInstr, O::I32X4ExtendLowI16X8S, F::Simd},
      {"i32x4.extend_low_i16x8_u"_su8, TT::BareInstr, O::I32X4ExtendLowI16X8U, F::Simd},
      {"i32x4.extmul_high_i16x8_s"_su8, TT::BareInstr, O::I32X4ExtmulHighI16X8S, F::Simd},
      {"i32x4.extmul_high_i16x8_u"_su8, TT::BareInstr, O::I32X4ExtmulHighI16X8U, F::Simd},
      {"i32x4.extmul_low_i16x8_s"_su8, TT::BareInstr, O::I32X4ExtmulLowI16X8S, F::Simd},
      {"i32x4.extmul_low_i16x8_u"_su8, TT::BareInstr, O::I32X4ExtmulLowI16X8U, F::Simd},
      ...
      {"i32x4.trunc_sat_f64x2_s_zero"_su8, TT::BareInstr, O::I32X4TruncSatF64X2SZero, F::Simd},
      {"i32x4.trunc_sat_f64x2_u_zero"_su8, TT::BareInstr, O::I32X4TruncSatF64X2UZero, F::Simd},
      ...
      {"i64x2.abs"_su8, TT::BareInstr, O::I64X2Abs, F::Simd},
      {"i64x2.add"_su8, TT::BareInstr, O::I64X2Add, F::Simd},
      {"i64x2.all_true"_su8, TT::BareInstr, O::I64X2AllTrue, F::Simd},
      {"i64x2.bitmask"_su8, TT::BareInstr, O::I64X2Bitmask, F::Simd},
      {"i64x2.eq"_su8, TT::BareInstr, O::I64X2Eq, F::Simd},
      {"i64x2.extend_high_i32x4_s"_su8, TT::BareInstr, O::I64X2ExtendHighI32X4S, F::Simd},
      {"i64x2.extend_high_i32x4_u"_su8, TT::BareInstr, O::I64X2ExtendHighI32X4U, F::Simd},
      {"i64x2.extend_low_i32x4_s"_su8, TT::BareInstr, O::I64X2ExtendLowI32X4S, F::Simd},
      {"i64x2.extend_low_i32x4_u"_su8, TT::BareInstr, O::I64X2ExtendLowI32X4U, F::Simd},
      {"i64x2.extmul_high_i32x4_s"_su8, TT::BareInstr, O::I64X2ExtmulHighI32X4S, F::Simd},
      {"i64x2.extmul_high_i32x4_u"_su8, TT::BareInstr, O::I64X2ExtmulHighI32X4U, F::Simd},
      {"i64x2.extmul_low_i32x4_s"_su8, TT::BareInstr, O::I64X2ExtmulLowI32X4S, F::Simd},
      {"i64x2.extmul_low_i32x4_u"_su8, TT::BareInstr, O::I64X2ExtmulLowI32X4U, F::Simd},
      {"i64x2.extract_lane"_su8, TT::SimdLaneInstr, O::I64X2ExtractLane, F::Simd},
      {"i64x2.ge_s"_su8, TT::BareInstr, O::I64X2GeS, F::Simd},
      {"i64x2.gt_s"_su8, TT::BareInstr, O::I64X2GtS, F::Simd},
      {"i64x2.le_s"_su8, TT::BareInstr, O::I64X2LeS, F::Simd},
      {"i64x2.lt_s"_su8, TT::BareInstr, O::I64X2LtS, F::Simd},
      {"i64x2.mul"_su8, TT::BareInstr, O::I64X2Mul, F::Simd},
      {"i64x2.neg"_su8, TT::BareInstr, O::I64X2Neg, F::Simd},
      {"i64x2.ne"_su8, TT::BareInstr, O::I64X2Ne, F::Simd},
      ...
      {"i8x16.abs"_su8, TT::BareInstr, O::I8X16Abs, F::Simd},
      {"i8x16.add"_su8, TT::BareInstr, O::I8X16Add, F::Simd},
      {"i8x16.add_sat_s"_su8, TT::BareInstr, O::I8X16AddSatS, F::Simd},
      {"i8x16.add_sat_u"_su8, TT::BareInstr, O::I8X16AddSatU, F::Simd},
      {"i8x16.all_true"_su8, TT::BareInstr, O::I8X16AllTrue, F::Simd},
      {"i8x16.avgr_u"_su8, TT::BareInstr, O::I8X16AvgrU, F::Simd},
      {"i8x16.bitmask"_su8, TT::BareInstr, O::I8X16Bitmask, F::Simd},
      ...
      {"i8x16.popcnt"_su8, TT::BareInstr, O::I8X16Popcnt, F::Simd},
      ...
      {"i8x16.shuffle"_su8, TT::SimdShuffleInstr, O::I8X16Shuffle, F::Simd},
      {"i8x16.splat"_su8, TT::BareInstr, O::I8X16Splat, F::Simd},
      {"i8x16.sub"_su8, TT::BareInstr, O::I8X16Sub, F::Simd},
      {"i8x16.sub_sat_s"_su8, TT::BareInstr, O::I8X16SubSatS, F::Simd},
      {"i8x16.sub_sat_u"_su8, TT::BareInstr, O::I8X16SubSatU, F::Simd},
      {"i8x16.swizzle"_su8, TT::BareInstr, O::I8X16Swizzle, F::Simd},
      {"let"_su8, TT::LetInstr, O::Let, F::FunctionReferences},
      ...
      {"memory.fill"_su8, TT::MemoryOptInstr, O::MemoryFill, F::BulkMemory},
      {"memory.grow"_su8, TT::MemoryOptInstr, O::MemoryGrow, 0},
      {"memory.init"_su8, TT::MemoryInitInstr, O::MemoryInit, F::BulkMemory},
      {"memory.size"_su8, TT::MemoryOptInstr, O::MemorySize, 0},
      ...
      {"v128.any_true"_su8, TT::BareInstr, O::V128AnyTrue, F::Simd},
      {"v128.bitselect"_su8, TT::BareInstr, O::V128BitSelect, F::Simd},
      {"v128.const"_su8, TT::SimdConstInstr, O::V128Const, F::Simd},
      {"v128.load16_lane"_su8, TT::SimdMemoryLaneInstr, O::V128Load16Lane, F::Simd},
      {"v128.load16_splat"_su8, TT::MemoryInstr, O::V128Load16Splat, F::Simd},
      {"v128.load16x4_s"_su8, TT::MemoryInstr, O::V128Load16X4S, F::Simd},
      {"v128.load16x4_u"_su8, TT::MemoryInstr, O::V128Load16X4U, F::Simd},
      {"v128.load32_lane"_su8, TT::SimdMemoryLaneInstr, O::V128Load32Lane, F::Simd},
      {"v128.load32_splat"_su8, TT::MemoryInstr, O::V128Load32Splat, F::Simd},
      {"v128.load32x2_s"_su8, TT::MemoryInstr, O::V128Load32X2S, F::Simd},
      {"v128.load32x2_u"_su8, TT::MemoryInstr, O::V128Load32X2U, F::Simd},
      {"v128.load32_zero"_su8, TT::MemoryInstr, O::V128Load32Zero, F::Simd},
      {"v128.load64_lane"_su8, TT::SimdMemoryLaneInstr, O::V128Load64Lane, F::Simd},
      {"v128.load64_splat"_su8, TT::MemoryInstr, O::V128Load64Splat, F::Simd},
      {"v128.load64_zero"_su8, TT::MemoryInstr, O::V128Load64Zero, F::Simd},
      {"v128.load8_lane"_su8, TT::SimdMemoryLaneInstr, O::V128Load8Lane, F::Simd},
      {"v128.load8_splat"_su8, TT::MemoryInstr, O::V128Load8Splat, F::Simd},
      {"v128.load8x8_s"_su8, TT::MemoryInstr, O::V128Load8X8S, F::Simd},
      {"v128.load8x8_u"_su8, TT::MemoryInstr, O::V128Load8X8U, F::Simd},
      ...
      {"v128.store16_lane"_su8, TT::SimdMemoryLaneInstr, O::V128Store16Lane, F::Simd},
      {"v128.store32_lane"_su8, TT::SimdMemoryLaneInstr, O::V128Store32Lane, F::Simd},
      {"v128.store64_lane"_su8, TT::SimdMemoryLaneInstr, O::V128Store64Lane, F::Simd},
      {"v128.store8_lane"_su8, TT::SimdMemoryLaneInstr, O::V128Store8Lane, F::Simd},
