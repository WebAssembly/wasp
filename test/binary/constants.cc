...
const RT RT_RefNullFunc{MakeAt("\x6c\x6f"_su8, RefType_NullFunc)};
const RT RT_RefExtern{MakeAt("\x6b\x6f"_su8, RefType_Extern)};
const RT RT_RefNullExtern{MakeAt("\x6c\x68"_su8, RefType_NullExtern)};
...
const VT VT_RefNullFunc{MakeAt("\x6c\x6f"_su8, RT_RefNullFunc)};
const VT VT_RefExtern{MakeAt("\x6b\x6f"_su8, RT_RefExtern)};
const VT VT_RefNullExtern{MakeAt("\x6c\x68"_su8, RT_RefNullExtern)};
