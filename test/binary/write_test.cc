...
TEST(BinaryWriteTest, Instruction_simd) {
  ...
  ExpectWrite<I>("\xfd\x03\x01\x02"_su8, I{O::I32X4Load16X4S, MemArgImmediate{1, 2}});
  ExpectWrite<I>("\xfd\x04\x01\x02"_su8, I{O::I32X4Load16X4U, MemArgImmediate{1, 2}});
  ExpectWrite<I>("\xfd\x05\x01\x02"_su8, I{O::I64X2Load32X2S, MemArgImmediate{1, 2}});
  ExpectWrite<I>("\xfd\x06\x01\x02"_su8, I{O::I64X2Load32X2U, MemArgImmediate{1, 2}});
  ExpectWrite<I>("\xfd\x07\x01\x02"_su8, I{O::V8X16LoadSplat, MemArgImmediate{1, 2}});
  ExpectWrite<I>("\xfd\x08\x01\x02"_su8, I{O::V16X8LoadSplat, MemArgImmediate{1, 2}});
  ExpectWrite<I>("\xfd\x09\x01\x02"_su8, I{O::V32X4LoadSplat, MemArgImmediate{1, 2}});
  ExpectWrite<I>("\xfd\x0a\x01\x02"_su8, I{O::V64X2LoadSplat, MemArgImmediate{1, 2}});
  ExpectWrite<I>("\xfd\x0b\x03\x04"_su8, I{O::V128Store, MemArgImmediate{3, 4}});
  ExpectWrite<I>(
  ...
  ExpectWrite<I>("\xfd\x0e"_su8, I{O::V8X16Swizzle});
  ExpectWrite<I>("\xfd\x0f"_su8, I{O::I8X16Splat});
  ExpectWrite<I>("\xfd\x10"_su8, I{O::I16X8Splat});
  ExpectWrite<I>("\xfd\x11"_su8, I{O::I32X4Splat});
  ExpectWrite<I>("\xfd\x12"_su8, I{O::I64X2Splat});
  ExpectWrite<I>("\xfd\x13"_su8, I{O::F32X4Splat});
  ExpectWrite<I>("\xfd\x14"_su8, I{O::F64X2Splat});
  ExpectWrite<I>("\xfd\x15\x00"_su8, I{O::I8X16ExtractLaneS, u8{0}});
  ExpectWrite<I>("\xfd\x16\x00"_su8, I{O::I8X16ExtractLaneU, u8{0}});
  ExpectWrite<I>("\xfd\x17\x00"_su8, I{O::I8X16ReplaceLane, u8{0}});
  ExpectWrite<I>("\xfd\x18\x00"_su8, I{O::I16X8ExtractLaneS, u8{0}});
  ExpectWrite<I>("\xfd\x19\x00"_su8, I{O::I16X8ExtractLaneU, u8{0}});
  ExpectWrite<I>("\xfd\x1a\x00"_su8, I{O::I16X8ReplaceLane, u8{0}});
  ExpectWrite<I>("\xfd\x1b\x00"_su8, I{O::I32X4ExtractLane, u8{0}});
  ExpectWrite<I>("\xfd\x1c\x00"_su8, I{O::I32X4ReplaceLane, u8{0}});
  ExpectWrite<I>("\xfd\x1d\x00"_su8, I{O::I64X2ExtractLane, u8{0}});
  ExpectWrite<I>("\xfd\x1e\x00"_su8, I{O::I64X2ReplaceLane, u8{0}});
  ExpectWrite<I>("\xfd\x1f\x00"_su8, I{O::F32X4ExtractLane, u8{0}});
  ExpectWrite<I>("\xfd\x20\x00"_su8, I{O::F32X4ReplaceLane, u8{0}});
  ExpectWrite<I>("\xfd\x21\x00"_su8, I{O::F64X2ExtractLane, u8{0}});
  ExpectWrite<I>("\xfd\x22\x00"_su8, I{O::F64X2ReplaceLane, u8{0}});
  ExpectWrite<I>("\xfd\x23"_su8, I{O::I8X16Eq});
  ExpectWrite<I>("\xfd\x24"_su8, I{O::I8X16Ne});
  ExpectWrite<I>("\xfd\x25"_su8, I{O::I8X16LtS});
  ExpectWrite<I>("\xfd\x26"_su8, I{O::I8X16LtU});
  ExpectWrite<I>("\xfd\x27"_su8, I{O::I8X16GtS});
  ExpectWrite<I>("\xfd\x28"_su8, I{O::I8X16GtU});
  ExpectWrite<I>("\xfd\x29"_su8, I{O::I8X16LeS});
  ExpectWrite<I>("\xfd\x2a"_su8, I{O::I8X16LeU});
  ExpectWrite<I>("\xfd\x2b"_su8, I{O::I8X16GeS});
  ExpectWrite<I>("\xfd\x2c"_su8, I{O::I8X16GeU});
  ExpectWrite<I>("\xfd\x2d"_su8, I{O::I16X8Eq});
  ExpectWrite<I>("\xfd\x2e"_su8, I{O::I16X8Ne});
  ExpectWrite<I>("\xfd\x2f"_su8, I{O::I16X8LtS});
  ExpectWrite<I>("\xfd\x30"_su8, I{O::I16X8LtU});
  ExpectWrite<I>("\xfd\x31"_su8, I{O::I16X8GtS});
  ExpectWrite<I>("\xfd\x32"_su8, I{O::I16X8GtU});
  ExpectWrite<I>("\xfd\x33"_su8, I{O::I16X8LeS});
  ExpectWrite<I>("\xfd\x34"_su8, I{O::I16X8LeU});
  ExpectWrite<I>("\xfd\x35"_su8, I{O::I16X8GeS});
  ExpectWrite<I>("\xfd\x36"_su8, I{O::I16X8GeU});
  ExpectWrite<I>("\xfd\x37"_su8, I{O::I32X4Eq});
  ExpectWrite<I>("\xfd\x38"_su8, I{O::I32X4Ne});
  ExpectWrite<I>("\xfd\x39"_su8, I{O::I32X4LtS});
  ExpectWrite<I>("\xfd\x3a"_su8, I{O::I32X4LtU});
  ExpectWrite<I>("\xfd\x3b"_su8, I{O::I32X4GtS});
  ExpectWrite<I>("\xfd\x3c"_su8, I{O::I32X4GtU});
  ExpectWrite<I>("\xfd\x3d"_su8, I{O::I32X4LeS});
  ExpectWrite<I>("\xfd\x3e"_su8, I{O::I32X4LeU});
  ExpectWrite<I>("\xfd\x3f"_su8, I{O::I32X4GeS});
  ExpectWrite<I>("\xfd\x40"_su8, I{O::I32X4GeU});
  ExpectWrite<I>("\xfd\x41"_su8, I{O::F32X4Eq});
  ExpectWrite<I>("\xfd\x42"_su8, I{O::F32X4Ne});
  ExpectWrite<I>("\xfd\x43"_su8, I{O::F32X4Lt});
  ExpectWrite<I>("\xfd\x44"_su8, I{O::F32X4Gt});
  ExpectWrite<I>("\xfd\x45"_su8, I{O::F32X4Le});
  ExpectWrite<I>("\xfd\x46"_su8, I{O::F32X4Ge});
  ExpectWrite<I>("\xfd\x47"_su8, I{O::F64X2Eq});
  ExpectWrite<I>("\xfd\x48"_su8, I{O::F64X2Ne});
  ExpectWrite<I>("\xfd\x49"_su8, I{O::F64X2Lt});
  ExpectWrite<I>("\xfd\x4a"_su8, I{O::F64X2Gt});
  ExpectWrite<I>("\xfd\x4b"_su8, I{O::F64X2Le});
  ExpectWrite<I>("\xfd\x4c"_su8, I{O::F64X2Ge});
  ExpectWrite<I>("\xfd\x4d"_su8, I{O::V128Not});
  ExpectWrite<I>("\xfd\x4e"_su8, I{O::V128And});
  ExpectWrite<I>("\xfd\x4f"_su8, I{O::V128Andnot});
  ExpectWrite<I>("\xfd\x50"_su8, I{O::V128Or});
  ExpectWrite<I>("\xfd\x51"_su8, I{O::V128Xor});
  ExpectWrite<I>("\xfd\x52"_su8, I{O::V128BitSelect});
  ExpectWrite<I>("\xfd\x60"_su8, I{O::I8X16Abs});
  ExpectWrite<I>("\xfd\x61"_su8, I{O::I8X16Neg});
  ExpectWrite<I>("\xfd\x62"_su8, I{O::I8X16AnyTrue});
  ExpectWrite<I>("\xfd\x63"_su8, I{O::I8X16AllTrue});
  ExpectWrite<I>("\xfd\x65"_su8, I{O::I8X16NarrowI16X8S});
  ExpectWrite<I>("\xfd\x66"_su8, I{O::I8X16NarrowI16X8U});
  ExpectWrite<I>("\xfd\x6b"_su8, I{O::I8X16Shl});
  ExpectWrite<I>("\xfd\x6c"_su8, I{O::I8X16ShrS});
  ExpectWrite<I>("\xfd\x6d"_su8, I{O::I8X16ShrU});
  ExpectWrite<I>("\xfd\x6e"_su8, I{O::I8X16Add});
  ExpectWrite<I>("\xfd\x6f"_su8, I{O::I8X16AddSaturateS});
  ExpectWrite<I>("\xfd\x70"_su8, I{O::I8X16AddSaturateU});
  ExpectWrite<I>("\xfd\x71"_su8, I{O::I8X16Sub});
  ExpectWrite<I>("\xfd\x72"_su8, I{O::I8X16SubSaturateS});
  ExpectWrite<I>("\xfd\x73"_su8, I{O::I8X16SubSaturateU});
  ExpectWrite<I>("\xfd\x76"_su8, I{O::I8X16MinS});
  ExpectWrite<I>("\xfd\x77"_su8, I{O::I8X16MinU});
  ExpectWrite<I>("\xfd\x78"_su8, I{O::I8X16MaxS});
  ExpectWrite<I>("\xfd\x79"_su8, I{O::I8X16MaxU});
  ExpectWrite<I>("\xfd\x7b"_su8, I{O::I8X16AvgrU});
  ExpectWrite<I>("\xfd\x80\x01"_su8, I{O::I16X8Abs});
  ExpectWrite<I>("\xfd\x81\x01"_su8, I{O::I16X8Neg});
  ExpectWrite<I>("\xfd\x82\x01"_su8, I{O::I16X8AnyTrue});
  ExpectWrite<I>("\xfd\x83\x01"_su8, I{O::I16X8AllTrue});
  ExpectWrite<I>("\xfd\x85\x01"_su8, I{O::I16X8NarrowI32X4S});
  ExpectWrite<I>("\xfd\x86\x01"_su8, I{O::I16X8NarrowI32X4U});
  ExpectWrite<I>("\xfd\x87\x01"_su8, I{O::I16X8WidenLowI8X16S});
  ExpectWrite<I>("\xfd\x88\x01"_su8, I{O::I16X8WidenHighI8X16S});
  ExpectWrite<I>("\xfd\x89\x01"_su8, I{O::I16X8WidenLowI8X16U});
  ExpectWrite<I>("\xfd\x8a\x01"_su8, I{O::I16X8WidenHighI8X16U});
  ExpectWrite<I>("\xfd\x8b\x01"_su8, I{O::I16X8Shl});
  ExpectWrite<I>("\xfd\x8c\x01"_su8, I{O::I16X8ShrS});
  ExpectWrite<I>("\xfd\x8d\x01"_su8, I{O::I16X8ShrU});
  ExpectWrite<I>("\xfd\x8e\x01"_su8, I{O::I16X8Add});
  ExpectWrite<I>("\xfd\x8f\x01"_su8, I{O::I16X8AddSaturateS});
  ExpectWrite<I>("\xfd\x90\x01"_su8, I{O::I16X8AddSaturateU});
  ExpectWrite<I>("\xfd\x91\x01"_su8, I{O::I16X8Sub});
  ExpectWrite<I>("\xfd\x92\x01"_su8, I{O::I16X8SubSaturateS});
  ExpectWrite<I>("\xfd\x93\x01"_su8, I{O::I16X8SubSaturateU});
  ExpectWrite<I>("\xfd\x95\x01"_su8, I{O::I16X8Mul});
  ExpectWrite<I>("\xfd\x96\x01"_su8, I{O::I16X8MinS});
  ExpectWrite<I>("\xfd\x97\x01"_su8, I{O::I16X8MinU});
  ExpectWrite<I>("\xfd\x98\x01"_su8, I{O::I16X8MaxS});
  ExpectWrite<I>("\xfd\x99\x01"_su8, I{O::I16X8MaxU});
  ExpectWrite<I>("\xfd\x9b\x01"_su8, I{O::I16X8AvgrU});
  ExpectWrite<I>("\xfd\xa0\x01"_su8, I{O::I32X4Abs});
  ExpectWrite<I>("\xfd\xa1\x01"_su8, I{O::I32X4Neg});
  ExpectWrite<I>("\xfd\xa2\x01"_su8, I{O::I32X4AnyTrue});
  ExpectWrite<I>("\xfd\xa3\x01"_su8, I{O::I32X4AllTrue});
  ExpectWrite<I>("\xfd\xa7\x01"_su8, I{O::I32X4WidenLowI16X8S});
  ExpectWrite<I>("\xfd\xa8\x01"_su8, I{O::I32X4WidenHighI16X8S});
  ExpectWrite<I>("\xfd\xa9\x01"_su8, I{O::I32X4WidenLowI16X8U});
  ExpectWrite<I>("\xfd\xaa\x01"_su8, I{O::I32X4WidenHighI16X8U});
  ExpectWrite<I>("\xfd\xab\x01"_su8, I{O::I32X4Shl});
  ExpectWrite<I>("\xfd\xac\x01"_su8, I{O::I32X4ShrS});
  ExpectWrite<I>("\xfd\xad\x01"_su8, I{O::I32X4ShrU});
  ExpectWrite<I>("\xfd\xae\x01"_su8, I{O::I32X4Add});
  ExpectWrite<I>("\xfd\xb1\x01"_su8, I{O::I32X4Sub});
  ExpectWrite<I>("\xfd\xb5\x01"_su8, I{O::I32X4Mul});
  ExpectWrite<I>("\xfd\xb6\x01"_su8, I{O::I32X4MinS});
  ExpectWrite<I>("\xfd\xb7\x01"_su8, I{O::I32X4MinU});
  ExpectWrite<I>("\xfd\xb8\x01"_su8, I{O::I32X4MaxS});
  ExpectWrite<I>("\xfd\xb9\x01"_su8, I{O::I32X4MaxU});
  ExpectWrite<I>("\xfd\xc1\x01"_su8, I{O::I64X2Neg});
  ExpectWrite<I>("\xfd\xcb\x01"_su8, I{O::I64X2Shl});
  ExpectWrite<I>("\xfd\xcc\x01"_su8, I{O::I64X2ShrS});
  ExpectWrite<I>("\xfd\xcd\x01"_su8, I{O::I64X2ShrU});
  ExpectWrite<I>("\xfd\xce\x01"_su8, I{O::I64X2Add});
  ExpectWrite<I>("\xfd\xd1\x01"_su8, I{O::I64X2Sub});
  ExpectWrite<I>("\xfd\xd5\x01"_su8, I{O::I64X2Mul});
  ExpectWrite<I>("\xfd\xe0\x01"_su8, I{O::F32X4Abs});
  ExpectWrite<I>("\xfd\xe1\x01"_su8, I{O::F32X4Neg});
  ExpectWrite<I>("\xfd\xe3\x01"_su8, I{O::F32X4Sqrt});
  ExpectWrite<I>("\xfd\xe4\x01"_su8, I{O::F32X4Add});
  ExpectWrite<I>("\xfd\xe5\x01"_su8, I{O::F32X4Sub});
  ExpectWrite<I>("\xfd\xe6\x01"_su8, I{O::F32X4Mul});
  ExpectWrite<I>("\xfd\xe7\x01"_su8, I{O::F32X4Div});
  ExpectWrite<I>("\xfd\xe8\x01"_su8, I{O::F32X4Min});
  ExpectWrite<I>("\xfd\xe9\x01"_su8, I{O::F32X4Max});
  ExpectWrite<I>("\xfd\xec\x01"_su8, I{O::F64X2Abs});
  ExpectWrite<I>("\xfd\xed\x01"_su8, I{O::F64X2Neg});
  ExpectWrite<I>("\xfd\xef\x01"_su8, I{O::F64X2Sqrt});
  ExpectWrite<I>("\xfd\xf0\x01"_su8, I{O::F64X2Add});
  ExpectWrite<I>("\xfd\xf1\x01"_su8, I{O::F64X2Sub});
  ExpectWrite<I>("\xfd\xf2\x01"_su8, I{O::F64X2Mul});
  ExpectWrite<I>("\xfd\xf3\x01"_su8, I{O::F64X2Div});
  ExpectWrite<I>("\xfd\xf4\x01"_su8, I{O::F64X2Min});
  ExpectWrite<I>("\xfd\xf5\x01"_su8, I{O::F64X2Max});
  ExpectWrite<I>("\xfd\xf8\x01"_su8, I{O::I32X4TruncSatF32X4S});
  ExpectWrite<I>("\xfd\xf9\x01"_su8, I{O::I32X4TruncSatF32X4U});
  ExpectWrite<I>("\xfd\xfa\x01"_su8, I{O::F32X4ConvertI32X4S});
  ExpectWrite<I>("\xfd\xfb\x01"_su8, I{O::F32X4ConvertI32X4U});
}
...
TEST(BinaryWriteTest, Opcode_simd) {
  ...
  ExpectWrite<O>("\xfd\x01"_su8, O::I16X8Load8X8S);
  ExpectWrite<O>("\xfd\x02"_su8, O::I16X8Load8X8U);
  ExpectWrite<O>("\xfd\x03"_su8, O::I32X4Load16X4S);
  ExpectWrite<O>("\xfd\x04"_su8, O::I32X4Load16X4U);
  ExpectWrite<O>("\xfd\x05"_su8, O::I64X2Load32X2S);
  ExpectWrite<O>("\xfd\x06"_su8, O::I64X2Load32X2U);
  ExpectWrite<O>("\xfd\x07"_su8, O::V8X16LoadSplat);
  ExpectWrite<O>("\xfd\x08"_su8, O::V16X8LoadSplat);
  ExpectWrite<O>("\xfd\x09"_su8, O::V32X4LoadSplat);
  ExpectWrite<O>("\xfd\x0a"_su8, O::V64X2LoadSplat);
  ExpectWrite<O>("\xfd\x0b"_su8, O::V128Store);
  ExpectWrite<O>("\xfd\x0c"_su8, O::V128Const);
  ExpectWrite<O>("\xfd\x0d"_su8, O::V8X16Shuffle);
  ExpectWrite<O>("\xfd\x0e"_su8, O::V8X16Swizzle);
  ExpectWrite<O>("\xfd\x0f"_su8, O::I8X16Splat);
  ExpectWrite<O>("\xfd\x10"_su8, O::I16X8Splat);
  ExpectWrite<O>("\xfd\x11"_su8, O::I32X4Splat);
  ExpectWrite<O>("\xfd\x12"_su8, O::I64X2Splat);
  ExpectWrite<O>("\xfd\x13"_su8, O::F32X4Splat);
  ExpectWrite<O>("\xfd\x14"_su8, O::F64X2Splat);
  ExpectWrite<O>("\xfd\x15"_su8, O::I8X16ExtractLaneS);
  ExpectWrite<O>("\xfd\x16"_su8, O::I8X16ExtractLaneU);
  ExpectWrite<O>("\xfd\x17"_su8, O::I8X16ReplaceLane);
  ExpectWrite<O>("\xfd\x18"_su8, O::I16X8ExtractLaneS);
  ExpectWrite<O>("\xfd\x19"_su8, O::I16X8ExtractLaneU);
  ExpectWrite<O>("\xfd\x1a"_su8, O::I16X8ReplaceLane);
  ExpectWrite<O>("\xfd\x1b"_su8, O::I32X4ExtractLane);
  ExpectWrite<O>("\xfd\x1c"_su8, O::I32X4ReplaceLane);
  ExpectWrite<O>("\xfd\x1d"_su8, O::I64X2ExtractLane);
  ExpectWrite<O>("\xfd\x1e"_su8, O::I64X2ReplaceLane);
  ExpectWrite<O>("\xfd\x1f"_su8, O::F32X4ExtractLane);
  ExpectWrite<O>("\xfd\x20"_su8, O::F32X4ReplaceLane);
  ExpectWrite<O>("\xfd\x21"_su8, O::F64X2ExtractLane);
  ExpectWrite<O>("\xfd\x22"_su8, O::F64X2ReplaceLane);
  ExpectWrite<O>("\xfd\x23"_su8, O::I8X16Eq);
  ExpectWrite<O>("\xfd\x24"_su8, O::I8X16Ne);
  ExpectWrite<O>("\xfd\x25"_su8, O::I8X16LtS);
  ExpectWrite<O>("\xfd\x26"_su8, O::I8X16LtU);
  ExpectWrite<O>("\xfd\x27"_su8, O::I8X16GtS);
  ExpectWrite<O>("\xfd\x28"_su8, O::I8X16GtU);
  ExpectWrite<O>("\xfd\x29"_su8, O::I8X16LeS);
  ExpectWrite<O>("\xfd\x2a"_su8, O::I8X16LeU);
  ExpectWrite<O>("\xfd\x2b"_su8, O::I8X16GeS);
  ExpectWrite<O>("\xfd\x2c"_su8, O::I8X16GeU);
  ExpectWrite<O>("\xfd\x2d"_su8, O::I16X8Eq);
  ExpectWrite<O>("\xfd\x2e"_su8, O::I16X8Ne);
  ExpectWrite<O>("\xfd\x2f"_su8, O::I16X8LtS);
  ExpectWrite<O>("\xfd\x30"_su8, O::I16X8LtU);
  ExpectWrite<O>("\xfd\x31"_su8, O::I16X8GtS);
  ExpectWrite<O>("\xfd\x32"_su8, O::I16X8GtU);
  ExpectWrite<O>("\xfd\x33"_su8, O::I16X8LeS);
  ExpectWrite<O>("\xfd\x34"_su8, O::I16X8LeU);
  ExpectWrite<O>("\xfd\x35"_su8, O::I16X8GeS);
  ExpectWrite<O>("\xfd\x36"_su8, O::I16X8GeU);
  ExpectWrite<O>("\xfd\x37"_su8, O::I32X4Eq);
  ExpectWrite<O>("\xfd\x38"_su8, O::I32X4Ne);
  ExpectWrite<O>("\xfd\x39"_su8, O::I32X4LtS);
  ExpectWrite<O>("\xfd\x3a"_su8, O::I32X4LtU);
  ExpectWrite<O>("\xfd\x3b"_su8, O::I32X4GtS);
  ExpectWrite<O>("\xfd\x3c"_su8, O::I32X4GtU);
  ExpectWrite<O>("\xfd\x3d"_su8, O::I32X4LeS);
  ExpectWrite<O>("\xfd\x3e"_su8, O::I32X4LeU);
  ExpectWrite<O>("\xfd\x3f"_su8, O::I32X4GeS);
  ExpectWrite<O>("\xfd\x40"_su8, O::I32X4GeU);
  ExpectWrite<O>("\xfd\x41"_su8, O::F32X4Eq);
  ExpectWrite<O>("\xfd\x42"_su8, O::F32X4Ne);
  ExpectWrite<O>("\xfd\x43"_su8, O::F32X4Lt);
  ExpectWrite<O>("\xfd\x44"_su8, O::F32X4Gt);
  ExpectWrite<O>("\xfd\x45"_su8, O::F32X4Le);
  ExpectWrite<O>("\xfd\x46"_su8, O::F32X4Ge);
  ExpectWrite<O>("\xfd\x47"_su8, O::F64X2Eq);
  ExpectWrite<O>("\xfd\x48"_su8, O::F64X2Ne);
  ExpectWrite<O>("\xfd\x49"_su8, O::F64X2Lt);
  ExpectWrite<O>("\xfd\x4a"_su8, O::F64X2Gt);
  ExpectWrite<O>("\xfd\x4b"_su8, O::F64X2Le);
  ExpectWrite<O>("\xfd\x4c"_su8, O::F64X2Ge);
  ExpectWrite<O>("\xfd\x4d"_su8, O::V128Not);
  ExpectWrite<O>("\xfd\x4e"_su8, O::V128And);
  ExpectWrite<O>("\xfd\x4f"_su8, O::V128Andnot);
  ExpectWrite<O>("\xfd\x50"_su8, O::V128Or);
  ExpectWrite<O>("\xfd\x51"_su8, O::V128Xor);
  ExpectWrite<O>("\xfd\x52"_su8, O::V128BitSelect);
  ExpectWrite<O>("\xfd\x60"_su8, O::I8X16Abs);
  ExpectWrite<O>("\xfd\x61"_su8, O::I8X16Neg);
  ExpectWrite<O>("\xfd\x62"_su8, O::I8X16AnyTrue);
  ExpectWrite<O>("\xfd\x63"_su8, O::I8X16AllTrue);
  ExpectWrite<O>("\xfd\x65"_su8, O::I8X16NarrowI16X8S);
  ExpectWrite<O>("\xfd\x66"_su8, O::I8X16NarrowI16X8U);
  ExpectWrite<O>("\xfd\x6b"_su8, O::I8X16Shl);
  ExpectWrite<O>("\xfd\x6c"_su8, O::I8X16ShrS);
  ExpectWrite<O>("\xfd\x6d"_su8, O::I8X16ShrU);
  ExpectWrite<O>("\xfd\x6e"_su8, O::I8X16Add);
  ExpectWrite<O>("\xfd\x6f"_su8, O::I8X16AddSaturateS);
  ExpectWrite<O>("\xfd\x70"_su8, O::I8X16AddSaturateU);
  ExpectWrite<O>("\xfd\x71"_su8, O::I8X16Sub);
  ExpectWrite<O>("\xfd\x72"_su8, O::I8X16SubSaturateS);
  ExpectWrite<O>("\xfd\x73"_su8, O::I8X16SubSaturateU);
  ExpectWrite<O>("\xfd\x76"_su8, O::I8X16MinS);
  ExpectWrite<O>("\xfd\x77"_su8, O::I8X16MinU);
  ExpectWrite<O>("\xfd\x78"_su8, O::I8X16MaxS);
  ExpectWrite<O>("\xfd\x79"_su8, O::I8X16MaxU);
  ExpectWrite<O>("\xfd\x7b"_su8, O::I8X16AvgrU);
  ExpectWrite<O>("\xfd\x80\x01"_su8, O::I16X8Abs);
  ExpectWrite<O>("\xfd\x81\x01"_su8, O::I16X8Neg);
  ExpectWrite<O>("\xfd\x82\x01"_su8, O::I16X8AnyTrue);
  ExpectWrite<O>("\xfd\x83\x01"_su8, O::I16X8AllTrue);
  ExpectWrite<O>("\xfd\x85\x01"_su8, O::I16X8NarrowI32X4S);
  ExpectWrite<O>("\xfd\x86\x01"_su8, O::I16X8NarrowI32X4U);
  ExpectWrite<O>("\xfd\x87\x01"_su8, O::I16X8WidenLowI8X16S);
  ExpectWrite<O>("\xfd\x88\x01"_su8, O::I16X8WidenHighI8X16S);
  ExpectWrite<O>("\xfd\x89\x01"_su8, O::I16X8WidenLowI8X16U);
  ExpectWrite<O>("\xfd\x8a\x01"_su8, O::I16X8WidenHighI8X16U);
  ExpectWrite<O>("\xfd\x8b\x01"_su8, O::I16X8Shl);
  ExpectWrite<O>("\xfd\x8c\x01"_su8, O::I16X8ShrS);
  ExpectWrite<O>("\xfd\x8d\x01"_su8, O::I16X8ShrU);
  ExpectWrite<O>("\xfd\x8e\x01"_su8, O::I16X8Add);
  ExpectWrite<O>("\xfd\x8f\x01"_su8, O::I16X8AddSaturateS);
  ExpectWrite<O>("\xfd\x90\x01"_su8, O::I16X8AddSaturateU);
  ExpectWrite<O>("\xfd\x91\x01"_su8, O::I16X8Sub);
  ExpectWrite<O>("\xfd\x92\x01"_su8, O::I16X8SubSaturateS);
  ExpectWrite<O>("\xfd\x93\x01"_su8, O::I16X8SubSaturateU);
  ExpectWrite<O>("\xfd\x95\x01"_su8, O::I16X8Mul);
  ExpectWrite<O>("\xfd\x96\x01"_su8, O::I16X8MinS);
  ExpectWrite<O>("\xfd\x97\x01"_su8, O::I16X8MinU);
  ExpectWrite<O>("\xfd\x98\x01"_su8, O::I16X8MaxS);
  ExpectWrite<O>("\xfd\x99\x01"_su8, O::I16X8MaxU);
  ExpectWrite<O>("\xfd\x9b\x01"_su8, O::I16X8AvgrU);
  ExpectWrite<O>("\xfd\xa0\x01"_su8, O::I32X4Abs);
  ExpectWrite<O>("\xfd\xa1\x01"_su8, O::I32X4Neg);
  ExpectWrite<O>("\xfd\xa2\x01"_su8, O::I32X4AnyTrue);
  ExpectWrite<O>("\xfd\xa3\x01"_su8, O::I32X4AllTrue);
  ExpectWrite<O>("\xfd\xa7\x01"_su8, O::I32X4WidenLowI16X8S);
  ExpectWrite<O>("\xfd\xa8\x01"_su8, O::I32X4WidenHighI16X8S);
  ExpectWrite<O>("\xfd\xa9\x01"_su8, O::I32X4WidenLowI16X8U);
  ExpectWrite<O>("\xfd\xaa\x01"_su8, O::I32X4WidenHighI16X8U);
  ExpectWrite<O>("\xfd\xab\x01"_su8, O::I32X4Shl);
  ExpectWrite<O>("\xfd\xac\x01"_su8, O::I32X4ShrS);
  ExpectWrite<O>("\xfd\xad\x01"_su8, O::I32X4ShrU);
  ExpectWrite<O>("\xfd\xae\x01"_su8, O::I32X4Add);
  ExpectWrite<O>("\xfd\xb1\x01"_su8, O::I32X4Sub);
  ExpectWrite<O>("\xfd\xb5\x01"_su8, O::I32X4Mul);
  ExpectWrite<O>("\xfd\xb6\x01"_su8, O::I32X4MinS);
  ExpectWrite<O>("\xfd\xb7\x01"_su8, O::I32X4MinU);
  ExpectWrite<O>("\xfd\xb8\x01"_su8, O::I32X4MaxS);
  ExpectWrite<O>("\xfd\xb9\x01"_su8, O::I32X4MaxU);
  ExpectWrite<O>("\xfd\xc1\x01"_su8, O::I64X2Neg);
  ExpectWrite<O>("\xfd\xcb\x01"_su8, O::I64X2Shl);
  ExpectWrite<O>("\xfd\xcc\x01"_su8, O::I64X2ShrS);
  ExpectWrite<O>("\xfd\xcd\x01"_su8, O::I64X2ShrU);
  ExpectWrite<O>("\xfd\xce\x01"_su8, O::I64X2Add);
  ExpectWrite<O>("\xfd\xd1\x01"_su8, O::I64X2Sub);
  ExpectWrite<O>("\xfd\xd5\x01"_su8, O::I64X2Mul);
  ExpectWrite<O>("\xfd\xe0\x01"_su8, O::F32X4Abs);
  ExpectWrite<O>("\xfd\xe1\x01"_su8, O::F32X4Neg);
  ExpectWrite<O>("\xfd\xe3\x01"_su8, O::F32X4Sqrt);
  ExpectWrite<O>("\xfd\xe4\x01"_su8, O::F32X4Add);
  ExpectWrite<O>("\xfd\xe5\x01"_su8, O::F32X4Sub);
  ExpectWrite<O>("\xfd\xe6\x01"_su8, O::F32X4Mul);
  ExpectWrite<O>("\xfd\xe7\x01"_su8, O::F32X4Div);
  ExpectWrite<O>("\xfd\xe8\x01"_su8, O::F32X4Min);
  ExpectWrite<O>("\xfd\xe9\x01"_su8, O::F32X4Max);
  ExpectWrite<O>("\xfd\xec\x01"_su8, O::F64X2Abs);
  ExpectWrite<O>("\xfd\xed\x01"_su8, O::F64X2Neg);
  ExpectWrite<O>("\xfd\xef\x01"_su8, O::F64X2Sqrt);
  ExpectWrite<O>("\xfd\xf0\x01"_su8, O::F64X2Add);
  ExpectWrite<O>("\xfd\xf1\x01"_su8, O::F64X2Sub);
  ExpectWrite<O>("\xfd\xf2\x01"_su8, O::F64X2Mul);
  ExpectWrite<O>("\xfd\xf3\x01"_su8, O::F64X2Div);
  ExpectWrite<O>("\xfd\xf4\x01"_su8, O::F64X2Min);
  ExpectWrite<O>("\xfd\xf5\x01"_su8, O::F64X2Max);
  ExpectWrite<O>("\xfd\xf8\x01"_su8, O::I32X4TruncSatF32X4S);
  ExpectWrite<O>("\xfd\xf9\x01"_su8, O::I32X4TruncSatF32X4U);
  ExpectWrite<O>("\xfd\xfa\x01"_su8, O::F32X4ConvertI32X4S);
  ExpectWrite<O>("\xfd\xfb\x01"_su8, O::F32X4ConvertI32X4U);
}
