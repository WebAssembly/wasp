...
TEST(BinaryWriteTest, FunctionType) {
  ...
  ExpectWrite("\x02\x7f\x7e\x01\x7c"_su8,
              FunctionType{{VT_I32, VT_I64}, {VT_F64}});
}
...
TEST(BinaryWriteTest, GlobalType) {
  ExpectWrite("\x7f\x00"_su8, GlobalType{VT_I32, Mutability::Const});
  ExpectWrite("\x7d\x01"_su8, GlobalType{VT_F32, Mutability::Var});
}

TEST(BinaryWriteTest, Import) {
  ExpectWrite("\x01\x61\x04\x66unc\x00\x0b"_su8, Import{"a", "func", 11u});

  ExpectWrite("\x01\x62\x05table\x01\x70\x00\x01"_su8,
              Import{"b", "table", TableType{Limits{1}, RT_Funcref}});
...
TEST(BinaryWriteTest, Instruction) {
  ...
  ExpectWrite("\x02\x7f"_su8, I{O::Block, BT_I32});
  ExpectWrite("\x03\x40"_su8, I{O::Loop, BT_Void});
  ExpectWrite("\x04\x7c"_su8, I{O::If, BT_F64});
...
TEST(BinaryWriteTest, Instruction_reference_types) {
  ExpectWrite("\x1c\x02\x7f\x7e"_su8,
              I{O::SelectT, ValueTypeList{VT_I32, VT_I64}});
...
TEST(BinaryWriteTest, Instruction_simd) {
  ...
  ExpectWrite("\xfd\x01\x01\x02"_su8, I{O::V128Load8X8S, MemArgImmediate{1, 2}});
  ExpectWrite("\xfd\x02\x01\x02"_su8, I{O::V128Load8X8U, MemArgImmediate{1, 2}});
  ExpectWrite("\xfd\x03\x01\x02"_su8, I{O::V128Load16X4S, MemArgImmediate{1, 2}});
  ExpectWrite("\xfd\x04\x01\x02"_su8, I{O::V128Load16X4U, MemArgImmediate{1, 2}});
  ExpectWrite("\xfd\x05\x01\x02"_su8, I{O::V128Load32X2S, MemArgImmediate{1, 2}});
  ExpectWrite("\xfd\x06\x01\x02"_su8, I{O::V128Load32X2U, MemArgImmediate{1, 2}});
  ExpectWrite("\xfd\x07\x01\x02"_su8, I{O::V128Load8Splat, MemArgImmediate{1, 2}});
  ExpectWrite("\xfd\x08\x01\x02"_su8, I{O::V128Load16Splat, MemArgImmediate{1, 2}});
  ExpectWrite("\xfd\x09\x01\x02"_su8, I{O::V128Load32Splat, MemArgImmediate{1, 2}});
  ExpectWrite("\xfd\x0a\x01\x02"_su8, I{O::V128Load64Splat, MemArgImmediate{1, 2}});
  ...
  ExpectWrite("\xfd\x0e"_su8, I{O::I8X16Swizzle});
  ...
  ExpectWrite("\xfd\x53"_su8, I{O::V128AnyTrue});
  ExpectWrite("\xfd\x54\x01\x02"_su8, I{O::V128Load8Lane, MemArgImmediate{1, 2}});
  ExpectWrite("\xfd\x55\x01\x02"_su8, I{O::V128Load16Lane, MemArgImmediate{1, 2}});
  ExpectWrite("\xfd\x56\x01\x02"_su8, I{O::V128Load32Lane, MemArgImmediate{1, 2}});
  ExpectWrite("\xfd\x57\x01\x02"_su8, I{O::V128Load64Lane, MemArgImmediate{1, 2}});
  ExpectWrite("\xfd\x58\x01\x02"_su8, I{O::V128Store8Lane, MemArgImmediate{1, 2}});
  ExpectWrite("\xfd\x59\x01\x02"_su8, I{O::V128Store16Lane, MemArgImmediate{1, 2}});
  ExpectWrite("\xfd\x5a\x01\x02"_su8, I{O::V128Store32Lane, MemArgImmediate{1, 2}});
  ExpectWrite("\xfd\x5b\x01\x02"_su8, I{O::V128Store64Lane, MemArgImmediate{1, 2}});
  ExpectWrite("\xfd\x5c\x01\x02"_su8, I{O::V128Load32Zero, MemArgImmediate{1, 2}});
  ExpectWrite("\xfd\x5d\x01\x02"_su8, I{O::V128Load64Zero, MemArgImmediate{1, 2}});
  ExpectWrite("\xfd\x5e"_su8, I{O::F32X4DemoteF64X2Zero});
  ExpectWrite("\xfd\x5f"_su8, I{O::F64X2PromoteLowF32X4});
  ExpectWrite("\xfd\x60"_su8, I{O::I8X16Abs});
  ExpectWrite("\xfd\x61"_su8, I{O::I8X16Neg});
  ExpectWrite("\xfd\x62"_su8, I{O::I8X16Popcnt});
  ExpectWrite("\xfd\x63"_su8, I{O::I8X16AllTrue});
  ExpectWrite("\xfd\x64"_su8, I{O::I8X16Bitmask});
  ExpectWrite("\xfd\x65"_su8, I{O::I8X16NarrowI16X8S});
  ExpectWrite("\xfd\x66"_su8, I{O::I8X16NarrowI16X8U});
  ExpectWrite("\xfd\x67"_su8, I{O::F32X4Ceil});
  ExpectWrite("\xfd\x68"_su8, I{O::F32X4Floor});
  ExpectWrite("\xfd\x69"_su8, I{O::F32X4Trunc});
  ExpectWrite("\xfd\x6a"_su8, I{O::F32X4Nearest});
  ...
  ExpectWrite("\xfd\x6f"_su8, I{O::I8X16AddSatS});
  ExpectWrite("\xfd\x70"_su8, I{O::I8X16AddSatU});
  ExpectWrite("\xfd\x71"_su8, I{O::I8X16Sub});
  ExpectWrite("\xfd\x72"_su8, I{O::I8X16SubSatS});
  ExpectWrite("\xfd\x73"_su8, I{O::I8X16SubSatU});
  ExpectWrite("\xfd\x74"_su8, I{O::F64X2Ceil});
  ExpectWrite("\xfd\x75"_su8, I{O::F64X2Floor});
  ...
  ExpectWrite("\xfd\x7a"_su8, I{O::F64X2Trunc});
  ExpectWrite("\xfd\x7b"_su8, I{O::I8X16AvgrU});
  ExpectWrite("\xfd\x7c"_su8, I{O::I16X8ExtaddPairwiseI8X16S});
  ExpectWrite("\xfd\x7d"_su8, I{O::I16X8ExtaddPairwiseI8X16U});
  ExpectWrite("\xfd\x7e"_su8, I{O::I32X4ExtaddPairwiseI16X8S});
  ExpectWrite("\xfd\x7f"_su8, I{O::I32X4ExtaddPairwiseI16X8U});
  ExpectWrite("\xfd\x80\x01"_su8, I{O::I16X8Abs});
  ExpectWrite("\xfd\x81\x01"_su8, I{O::I16X8Neg});
  ExpectWrite("\xfd\x82\x01"_su8, I{O::I16X8Q15mulrSatS});
  ExpectWrite("\xfd\x83\x01"_su8, I{O::I16X8AllTrue});
  ExpectWrite("\xfd\x84\x01"_su8, I{O::I16X8Bitmask});
  ExpectWrite("\xfd\x85\x01"_su8, I{O::I16X8NarrowI32X4S});
  ExpectWrite("\xfd\x86\x01"_su8, I{O::I16X8NarrowI32X4U});
  ExpectWrite("\xfd\x87\x01"_su8, I{O::I16X8ExtendLowI8X16S});
  ExpectWrite("\xfd\x88\x01"_su8, I{O::I16X8ExtendHighI8X16S});
  ExpectWrite("\xfd\x89\x01"_su8, I{O::I16X8ExtendLowI8X16U});
  ExpectWrite("\xfd\x8a\x01"_su8, I{O::I16X8ExtendHighI8X16U});
  ...
  ExpectWrite("\xfd\x8f\x01"_su8, I{O::I16X8AddSatS});
  ExpectWrite("\xfd\x90\x01"_su8, I{O::I16X8AddSatU});
  ExpectWrite("\xfd\x91\x01"_su8, I{O::I16X8Sub});
  ExpectWrite("\xfd\x92\x01"_su8, I{O::I16X8SubSatS});
  ExpectWrite("\xfd\x93\x01"_su8, I{O::I16X8SubSatU});
  ExpectWrite("\xfd\x94\x01"_su8, I{O::F64X2Nearest});
  ...
  ExpectWrite("\xfd\x9c\x01"_su8, I{O::I16X8ExtmulLowI8X16S});
  ExpectWrite("\xfd\x9d\x01"_su8, I{O::I16X8ExtmulHighI8X16S});
  ExpectWrite("\xfd\x9e\x01"_su8, I{O::I16X8ExtmulLowI8X16U});
  ExpectWrite("\xfd\x9f\x01"_su8, I{O::I16X8ExtmulHighI8X16U});
  ...
  ExpectWrite("\xfd\xa4\x01"_su8, I{O::I32X4Bitmask});
  ExpectWrite("\xfd\xa7\x01"_su8, I{O::I32X4ExtendLowI16X8S});
  ExpectWrite("\xfd\xa8\x01"_su8, I{O::I32X4ExtendHighI16X8S});
  ExpectWrite("\xfd\xa9\x01"_su8, I{O::I32X4ExtendLowI16X8U});
  ExpectWrite("\xfd\xaa\x01"_su8, I{O::I32X4ExtendHighI16X8U});
  ...
  ExpectWrite("\xfd\xba\x01"_su8, I{O::I32X4DotI16X8S});
  ExpectWrite("\xfd\xbc\x01"_su8, I{O::I32X4ExtmulLowI16X8S});
  ExpectWrite("\xfd\xbd\x01"_su8, I{O::I32X4ExtmulHighI16X8S});
  ExpectWrite("\xfd\xbe\x01"_su8, I{O::I32X4ExtmulLowI16X8U});
  ExpectWrite("\xfd\xbf\x01"_su8, I{O::I32X4ExtmulHighI16X8U});
  ExpectWrite("\xfd\xc0\x01"_su8, I{O::I64X2Abs});
  ExpectWrite("\xfd\xc1\x01"_su8, I{O::I64X2Neg});
  ExpectWrite("\xfd\xc3\x01"_su8, I{O::I64X2AllTrue});
  ExpectWrite("\xfd\xc4\x01"_su8, I{O::I64X2Bitmask});
  ExpectWrite("\xfd\xc7\x01"_su8, I{O::I64X2ExtendLowI32X4S});
  ExpectWrite("\xfd\xc8\x01"_su8, I{O::I64X2ExtendHighI32X4S});
  ExpectWrite("\xfd\xc9\x01"_su8, I{O::I64X2ExtendLowI32X4U});
  ExpectWrite("\xfd\xca\x01"_su8, I{O::I64X2ExtendHighI32X4U});
  ...
  ExpectWrite("\xfd\xd6\x01"_su8, I{O::I64X2Eq});
  ExpectWrite("\xfd\xd7\x01"_su8, I{O::I64X2Ne});
  ExpectWrite("\xfd\xd8\x01"_su8, I{O::I64X2LtS});
  ExpectWrite("\xfd\xd9\x01"_su8, I{O::I64X2GtS});
  ExpectWrite("\xfd\xda\x01"_su8, I{O::I64X2LeS});
  ExpectWrite("\xfd\xdb\x01"_su8, I{O::I64X2GeS});
  ExpectWrite("\xfd\xdc\x01"_su8, I{O::I64X2ExtmulLowI32X4S});
  ExpectWrite("\xfd\xdd\x01"_su8, I{O::I64X2ExtmulHighI32X4S});
  ExpectWrite("\xfd\xde\x01"_su8, I{O::I64X2ExtmulLowI32X4U});
  ExpectWrite("\xfd\xdf\x01"_su8, I{O::I64X2ExtmulHighI32X4U});
  ...
  ExpectWrite("\xfd\xea\x01"_su8, I{O::F32X4Pmin});
  ExpectWrite("\xfd\xeb\x01"_su8, I{O::F32X4Pmax});
  ...
  ExpectWrite("\xfd\xf6\x01"_su8, I{O::F64X2Pmin});
  ExpectWrite("\xfd\xf7\x01"_su8, I{O::F64X2Pmax});
  ...
  ExpectWrite("\xfd\xfc\x01"_su8, I{O::I32X4TruncSatF64X2SZero});
  ExpectWrite("\xfd\xfd\x01"_su8, I{O::I32X4TruncSatF64X2UZero});
  ExpectWrite("\xfd\xfe\x01"_su8, I{O::F64X2ConvertLowI32X4S});
  ExpectWrite("\xfd\xff\x01"_su8, I{O::F64X2ConvertLowI32X4U});
}
...
TEST(BinaryWriteTest, Locals) {
  ExpectWrite("\x02\x7f"_su8, Locals{2, VT_I32});
  ExpectWrite("\xc0\x02\x7c"_su8, Locals{320, VT_F64});
}

TEST(BinaryWriteTest, LetImmediate) {
  ExpectWrite("\x40\x00"_su8, LetImmediate{BT_Void, LocalsList{}});
  ExpectWrite("\x00\x01\x02\x7f"_su8,
              LetImmediate{BlockType{Index{0}}, LocalsList{Locals{2, VT_I32}}});
}
...
TEST(BinaryWriteTest, Module_Table) {
  Module module;
  module.tables.push_back(Table{TableType{Limits{1}, RT_Funcref}});
  module.tables.push_back(Table{TableType{Limits{2}, RT_Externref}});
...
TEST(BinaryWriteTest, Module_Code) {
  ...
  module.codes.push_back(
      UnpackedCode{LocalsList{Locals{2, VT_I32}, Locals{1, VT_I64}},
...
TEST(BinaryWriteTest, Opcode_simd) {
  ...
  ExpectWrite("\xfd\x01"_su8, O::V128Load8X8S);
  ExpectWrite("\xfd\x02"_su8, O::V128Load8X8U);
  ExpectWrite("\xfd\x03"_su8, O::V128Load16X4S);
  ExpectWrite("\xfd\x04"_su8, O::V128Load16X4U);
  ExpectWrite("\xfd\x05"_su8, O::V128Load32X2S);
  ExpectWrite("\xfd\x06"_su8, O::V128Load32X2U);
  ExpectWrite("\xfd\x07"_su8, O::V128Load8Splat);
  ExpectWrite("\xfd\x08"_su8, O::V128Load16Splat);
  ExpectWrite("\xfd\x09"_su8, O::V128Load32Splat);
  ExpectWrite("\xfd\x0a"_su8, O::V128Load64Splat);
  ExpectWrite("\xfd\x0b"_su8, O::V128Store);
  ExpectWrite("\xfd\x0c"_su8, O::V128Const);
  ExpectWrite("\xfd\x0d"_su8, O::I8X16Shuffle);
  ExpectWrite("\xfd\x0e"_su8, O::I8X16Swizzle);
  ...
  ExpectWrite("\xfd\x53"_su8, O::V128AnyTrue);
  ExpectWrite("\xfd\x54"_su8, O::V128Load8Lane);
  ExpectWrite("\xfd\x55"_su8, O::V128Load16Lane);
  ExpectWrite("\xfd\x56"_su8, O::V128Load32Lane);
  ExpectWrite("\xfd\x57"_su8, O::V128Load64Lane);
  ExpectWrite("\xfd\x58"_su8, O::V128Store8Lane);
  ExpectWrite("\xfd\x59"_su8, O::V128Store16Lane);
  ExpectWrite("\xfd\x5a"_su8, O::V128Store32Lane);
  ExpectWrite("\xfd\x5b"_su8, O::V128Store64Lane);
  ExpectWrite("\xfd\x5c"_su8, O::V128Load32Zero);
  ExpectWrite("\xfd\x5d"_su8, O::V128Load64Zero);
  ExpectWrite("\xfd\x5e"_su8, O::F32X4DemoteF64X2Zero);
  ExpectWrite("\xfd\x5f"_su8, O::F64X2PromoteLowF32X4);
  ExpectWrite("\xfd\x60"_su8, O::I8X16Abs);
  ExpectWrite("\xfd\x61"_su8, O::I8X16Neg);
  ExpectWrite("\xfd\x62"_su8, O::I8X16Popcnt);
  ExpectWrite("\xfd\x63"_su8, O::I8X16AllTrue);
  ExpectWrite("\xfd\x64"_su8, O::I8X16Bitmask);
  ExpectWrite("\xfd\x65"_su8, O::I8X16NarrowI16X8S);
  ExpectWrite("\xfd\x66"_su8, O::I8X16NarrowI16X8U);
  ExpectWrite("\xfd\x67"_su8, O::F32X4Ceil);
  ExpectWrite("\xfd\x68"_su8, O::F32X4Floor);
  ExpectWrite("\xfd\x69"_su8, O::F32X4Trunc);
  ExpectWrite("\xfd\x6a"_su8, O::F32X4Nearest);
  ...
  ExpectWrite("\xfd\x6f"_su8, O::I8X16AddSatS);
  ExpectWrite("\xfd\x70"_su8, O::I8X16AddSatU);
  ExpectWrite("\xfd\x71"_su8, O::I8X16Sub);
  ExpectWrite("\xfd\x72"_su8, O::I8X16SubSatS);
  ExpectWrite("\xfd\x73"_su8, O::I8X16SubSatU);
  ExpectWrite("\xfd\x74"_su8, O::F64X2Ceil);
  ExpectWrite("\xfd\x75"_su8, O::F64X2Floor);
  ...
  ExpectWrite("\xfd\x7a"_su8, O::F64X2Trunc);
  ExpectWrite("\xfd\x7b"_su8, O::I8X16AvgrU);
  ExpectWrite("\xfd\x7c"_su8, O::I16X8ExtaddPairwiseI8X16S);
  ExpectWrite("\xfd\x7d"_su8, O::I16X8ExtaddPairwiseI8X16U);
  ExpectWrite("\xfd\x7e"_su8, O::I32X4ExtaddPairwiseI16X8S);
  ExpectWrite("\xfd\x7f"_su8, O::I32X4ExtaddPairwiseI16X8U);
  ExpectWrite("\xfd\x80\x01"_su8, O::I16X8Abs);
  ExpectWrite("\xfd\x81\x01"_su8, O::I16X8Neg);
  ExpectWrite("\xfd\x82\x01"_su8, O::I16X8Q15mulrSatS);
  ExpectWrite("\xfd\x83\x01"_su8, O::I16X8AllTrue);
  ExpectWrite("\xfd\x84\x01"_su8, O::I16X8Bitmask);
  ExpectWrite("\xfd\x85\x01"_su8, O::I16X8NarrowI32X4S);
  ExpectWrite("\xfd\x86\x01"_su8, O::I16X8NarrowI32X4U);
  ExpectWrite("\xfd\x87\x01"_su8, O::I16X8ExtendLowI8X16S);
  ExpectWrite("\xfd\x88\x01"_su8, O::I16X8ExtendHighI8X16S);
  ExpectWrite("\xfd\x89\x01"_su8, O::I16X8ExtendLowI8X16U);
  ExpectWrite("\xfd\x8a\x01"_su8, O::I16X8ExtendHighI8X16U);
  ...
  ExpectWrite("\xfd\x8f\x01"_su8, O::I16X8AddSatS);
  ExpectWrite("\xfd\x90\x01"_su8, O::I16X8AddSatU);
  ExpectWrite("\xfd\x91\x01"_su8, O::I16X8Sub);
  ExpectWrite("\xfd\x92\x01"_su8, O::I16X8SubSatS);
  ExpectWrite("\xfd\x93\x01"_su8, O::I16X8SubSatU);
  ExpectWrite("\xfd\x94\x01"_su8, O::F64X2Nearest);
  ...
  ExpectWrite("\xfd\x9c\x01"_su8, O::I16X8ExtmulLowI8X16S);
  ExpectWrite("\xfd\x9d\x01"_su8, O::I16X8ExtmulHighI8X16S);
  ExpectWrite("\xfd\x9e\x01"_su8, O::I16X8ExtmulLowI8X16U);
  ExpectWrite("\xfd\x9f\x01"_su8, O::I16X8ExtmulHighI8X16U);
  ...
  ExpectWrite("\xfd\xa4\x01"_su8, O::I32X4Bitmask);
  ExpectWrite("\xfd\xa7\x01"_su8, O::I32X4ExtendLowI16X8S);
  ExpectWrite("\xfd\xa8\x01"_su8, O::I32X4ExtendHighI16X8S);
  ExpectWrite("\xfd\xa9\x01"_su8, O::I32X4ExtendLowI16X8U);
  ExpectWrite("\xfd\xaa\x01"_su8, O::I32X4ExtendHighI16X8U);
  ...
  ExpectWrite("\xfd\xba\x01"_su8, O::I32X4DotI16X8S);
  ExpectWrite("\xfd\xbc\x01"_su8, O::I32X4ExtmulLowI16X8S);
  ExpectWrite("\xfd\xbd\x01"_su8, O::I32X4ExtmulHighI16X8S);
  ExpectWrite("\xfd\xbe\x01"_su8, O::I32X4ExtmulLowI16X8U);
  ExpectWrite("\xfd\xbf\x01"_su8, O::I32X4ExtmulHighI16X8U);
  ExpectWrite("\xfd\xc0\x01"_su8, O::I64X2Abs);
  ExpectWrite("\xfd\xc1\x01"_su8, O::I64X2Neg);
  ExpectWrite("\xfd\xc3\x01"_su8, O::I64X2AllTrue);
  ExpectWrite("\xfd\xc4\x01"_su8, O::I64X2Bitmask);
  ExpectWrite("\xfd\xc7\x01"_su8, O::I64X2ExtendLowI32X4S);
  ExpectWrite("\xfd\xc8\x01"_su8, O::I64X2ExtendHighI32X4S);
  ExpectWrite("\xfd\xc9\x01"_su8, O::I64X2ExtendLowI32X4U);
  ExpectWrite("\xfd\xca\x01"_su8, O::I64X2ExtendHighI32X4U);
  ...
  ExpectWrite("\xfd\xd6\x01"_su8, O::I64X2Eq);
  ExpectWrite("\xfd\xd7\x01"_su8, O::I64X2Ne);
  ExpectWrite("\xfd\xd8\x01"_su8, O::I64X2LtS);
  ExpectWrite("\xfd\xd9\x01"_su8, O::I64X2GtS);
  ExpectWrite("\xfd\xda\x01"_su8, O::I64X2LeS);
  ExpectWrite("\xfd\xdb\x01"_su8, O::I64X2GeS);
  ExpectWrite("\xfd\xdc\x01"_su8, O::I64X2ExtmulLowI32X4S);
  ExpectWrite("\xfd\xdd\x01"_su8, O::I64X2ExtmulHighI32X4S);
  ExpectWrite("\xfd\xde\x01"_su8, O::I64X2ExtmulLowI32X4U);
  ExpectWrite("\xfd\xdf\x01"_su8, O::I64X2ExtmulHighI32X4U);
  ...
  ExpectWrite("\xfd\xea\x01"_su8, O::F32X4Pmin);
  ExpectWrite("\xfd\xeb\x01"_su8, O::F32X4Pmax);
  ...
  ExpectWrite("\xfd\xf6\x01"_su8, O::F64X2Pmin);
  ExpectWrite("\xfd\xf7\x01"_su8, O::F64X2Pmax);
  ...
  ExpectWrite("\xfd\xfc\x01"_su8, O::I32X4TruncSatF64X2SZero);
  ExpectWrite("\xfd\xfd\x01"_su8, O::I32X4TruncSatF64X2UZero);
  ExpectWrite("\xfd\xfe\x01"_su8, O::F64X2ConvertLowI32X4S);
  ExpectWrite("\xfd\xff\x01"_su8, O::F64X2ConvertLowI32X4U);
}
...
TEST(BinaryWriteTest, TableType) {
  ExpectWrite("\x70\x00\x01"_su8, TableType{Limits{1}, RT_Funcref});
